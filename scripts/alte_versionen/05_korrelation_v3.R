...
# Korrelationsmatrix nach APA-Standard erstellen und speichern
apa.cor.table(subset_cor, filename = file.path(output_dir, "korrelationstabelle.doc"), table.number = 1)
