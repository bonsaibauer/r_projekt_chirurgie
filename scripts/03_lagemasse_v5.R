...
# inkl. Histogramme und stargazer-Tabelle (nur Mean, Median, Mode)
cat("----------------------------------------- \n")
cat("03_lagemasse.R \n")
cat("----------------------------------------- \n")
# ---------------------------------------------
...
# Funktion zur Berechnung der Lagemaße
...
# Berechnungen der Lagemaße für verschiedene Variablen
lagemaße_df <- rbind(
...
# ---------------------------------------------
# Stargazer-Tabelle als txt speichern

cat("🔄 Erstelle stargazer-Tabelle als .txt...\n")

# Stargazer für die Lagemaße in einer strukturierten Textdatei ausgeben (nur Mean, Median, Mode)
stargazer(lagemaße_df[, c("Variable", "Mean", "Median", "Mode")], type = "text", summary = FALSE, rownames = FALSE,
          out = file.path(export_dir, "lagemasse_tabelle.txt"))
